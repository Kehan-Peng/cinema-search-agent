...
def init_db(force_seed: bool = False) -> None:
    ...
    try:
        ...
        cursor.executescript(
            ...
            CREATE INDEX IF NOT EXISTS idx_watch_records_user ON watch_records(user_email);
            CREATE INDEX IF NOT EXISTS idx_watch_records_date ON watch_records(watch_date);
            CREATE INDEX IF NOT EXISTS idx_watchlist_user ON watchlist(user_email);
            CREATE INDEX IF NOT EXISTS idx_watch_notes_user ON watch_notes(user_email);
            """
        )
        conn.commit()
